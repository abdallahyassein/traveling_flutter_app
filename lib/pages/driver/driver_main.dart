...
import 'package:mechanicscarfix/pages/driver/request_check_form.dart';
...
class _DriverMainPageState extends State<DriverMainPage> {
  ...
  Widget build(BuildContext context) {
    var issues = DriverHelper.getAllOpenIssues();
                          ...
                          builder: (context, snapshot) {
                            if (snapshot.connectionState ==
                              ...
                              return Padding(
                                ...
                                child: Center(
                                    child: Text(
                                        "There are no invitations right now , good luck",
                                        textAlign: TextAlign.center,
                                        style: GoogleFonts.antic(
                                          textStyle: TextStyle(
                                              color: Colors.white,
                              ...
                              return Padding(
                                ...
                                child: Center(
                                    child: Text(
                                        "There are no invitations right now , pleasee check your unfixed problem first",
                                        textAlign: TextAlign.center,
                                        style: GoogleFonts.antic(
                                          textStyle: TextStyle(
                                              color: Colors.white,
